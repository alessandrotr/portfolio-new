...
function GermanFlag() {
  return (
    <svg viewBox="0 0 60 30" className="w-full h-full object-cover">
      <rect y="-15" width="60" height="20" fill="black" />
      <rect y="5" width="60" height="20" fill="red" />
      <rect y="25" width="60" height="20" fill="gold" />
    </svg>
  );
}
...
function ItalianFlag() {
  return (
    <svg viewBox="0 0 60 30" className="w-full h-full object-cover">
      <rect y="-15" width="20" height="60" fill="green" />
      <rect y="-15" x="20" width="20" height="60" fill="white" />
      <rect y="-15" x="40" width="20" height="60" fill="red" />
    </svg>
  );
}
