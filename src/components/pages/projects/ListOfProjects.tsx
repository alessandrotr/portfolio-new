  ...
  return (
    <>
      ...
      <div
        ...
        } duration-500 xl:left-8 pt-28 xl:pt-0 top-0 xl:top-[23%] gap-4 w-full h-screen xl:h-auto xl:w-[350px] min-w-[350px] xl:max-w-[350px] flex flex-col fixed transition-all z-20 bg-primaryDark xl:bg-transparent`}
      >
